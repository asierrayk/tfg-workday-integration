...
\begin{tikzpicture}[node distance = 3cm, auto]
	...
	\node [startstop] (deal_creation) {Crear Deal};
	...
	\node [decision,below of =get_deal] (valid) {\begin{tabular}{c}¿Dealstage \\ válido? \end{tabular}};
	\node [process, below of=valid] (submit_customer) {Subir customer a Workday};
	\node [process, below of=submit_customer] (submit_project) {Subir project a Workday};
...
\caption{Proceso Crear Deal} \label{fig:validation_message}
\end{figure}