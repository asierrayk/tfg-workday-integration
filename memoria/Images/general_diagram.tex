...
\caption{Diagrama general del sistema \\ \small Modificación de ejemplo de \textit{TikZ} (\href{http://www.texample.net/tikz/examples/computer-science-mindmap/}{\textit{Till Tantau}})} 
