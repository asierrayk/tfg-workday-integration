...
\end{tikzpicture}
\caption{Estados por los que pasa un deal \\ \small Modificación de ejemplo de \textit{TikZ} (\href{http://www.texample.net/tikz/examples/pera-model/}{\textit{Erno Pentzin}})}
