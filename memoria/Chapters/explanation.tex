...
Para su implementación he usado el módulo \textit{ConfigParser} parte de una librería estandar. \textit{ConfigParser} facilita la lectura de archivos de configuración. A estos archivos se les suele poner la extensión \textit{ini}. %TODO footnote cofigparser
...
\item \textbf{Dinámico}: Se trata de la base de datos local \textit{SQLite3} para \textit{python}. %TODO footnote sqlite3
