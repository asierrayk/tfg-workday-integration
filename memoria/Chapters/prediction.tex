...
El resultado de todo el proceso ha dado lugar al modelo. Este modelo esta formado por un conjunto de caracterícticas, un estimador y sus parametros.
...
\begin{itemize}
	...
	\item \textbf{Estimador}: Tras comparar varios estimadores, se eligio el que daba lugar a un mejor resultado. Este estimador fue el de regresión logística.
	
	\item \textbf{Parametros}: La búsqueda de los parámetros con \textit{GridSearchCV} ha dado lugar a la siguiente configuración del Código \ref{lst:estimator_definition}.\\
...
De este modo podremos obtener el mejor resultado al realizar predicciones sobre datos que esten fuera de nuestra población inicial.\\
