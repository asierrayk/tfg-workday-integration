...
\begin{itemize}
	...
	\item \textbf{Aprendizaje no supervisado}. En este tipo de aprendizaje los datos de entrenamiento no cuentan con una caracteriítica que indique la información que se quiere predecir. Puede usarse con varios objetivos, aunque el más común es clasificar los datos en grupos con similitudes.
\end{itemize}
